...
final class OCEANWP_Theme_Class
{
	...
	public static function theme_css()
	{
		...
		wp_enqueue_style('bootstrap-style',  $dir . 'third/bootstrap.css', null, $theme_version);
		...
		wp_enqueue_style('lightbox', $dir . 'third/lightbox/css/lightbox.min.css', false, $theme_version);

		wp_enqueue_style('provider-style', $dir . 'algolia/out/providers.css', false, $theme_version);
		wp_enqueue_style('course-style', $dir . 'algolia/out/courses.css', false, $theme_version);
		wp_enqueue_style('geolocalization-style', $dir . 'algolia/out/geolocalizations.css', false, $theme_version);
		wp_enqueue_style('actors-style', $dir . 'algolia/out/actors.css', false, $theme_version);
	}
	...
	public static function theme_js()
	{
		...
		wp_enqueue_script(
			'content',
			$dir . 'third/content.js',
			['jquery'],
			false
		);

		wp_enqueue_script('lightbox',  $dir . 'third/lightbox/lightbox.min.js', ['jquery'], false);

		wp_enqueue_script('bootstrap-bundle',  $dir . 'third/bootstrap.bundle.js', ['jquery'], false);
		wp_enqueue_script('polyfill', 'https://polyfill.io/v3/polyfill.min.js?features=default', null, null, true);
	}
	...
	if($related_cats_post->have_posts()):
		 while($related_cats_post->have_posts()): $related_cats_post->the_post(); ?>
			<ul style="display:inline">
				<li style="display:inline">
					<a href="<?php the_permalink(); ?>" style="text-decoration:none; display:inline;">
						<?php the_title(); ?>
					</a>
				</li>
			</ul>
		<?php endwhile;
			echo "<div class='page-nav-container'>" . paginate_links(array(
				'total' => $related_cats_post->max_num_pages,
				'prev_text' => __('<'),
				'next_text' => __('>')
			)) . "</div>";
